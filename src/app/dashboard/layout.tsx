...
// Layout du dashboard — sidebar fixe + zone de contenu
...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/posts',    icon: '✦', label: 'Publications' },
  { href: '/dashboard/posts/new',icon: '+', label: 'Nouvelle publication' },
  { href: '/dashboard/comments', icon: '✉', label: 'Commentaires' },
